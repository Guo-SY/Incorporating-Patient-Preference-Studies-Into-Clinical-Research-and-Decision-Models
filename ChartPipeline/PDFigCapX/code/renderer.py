...
def render_pdf(filename, customize_dpi):
    ...
    rasterScale = 15000  # increase this if you want higher resolution images 
    ...
    if os.name == 'nt':
        imagemagickPath = '/content/drive/MyDrive/ADSP_Project/Code/ChartPipeline/ImageMagick-7.1.1-26-portable-Q16-x86/convert.exe'
